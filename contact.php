...
<label for="Complain type:" accesskey="p">Complain type:</label>

   <select name="Complain type">
  <option value="" disabled selected>Select your option</option>
   <option value="electricity issue">electricity issue</option>
    ...
    <option value="unhygenic management">unhygenic management</option>
...
<?php
if(isset($_POST['Complain type'])) {
  echo "Selected complain: ".htmlspecialchars($_POST['complain type']);
}
?>
							</div>
						</div>
...
if(isset($_POST['submit'])){
	...
	$query = "INSERT INTO Message (sender_id,sender_name,receiver_id,hostel_id,subject_h,message,msg_date,msg_time) VALUES ('$roll','$fname','$hos_man_id','$hostel_id','$subject','$message','$today_date','$time')";
