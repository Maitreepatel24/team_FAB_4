		...
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					...
					<li class="nav-item">
						<a class="nav-link" href="message_hostel_manager.php">Complaint Received</a>
					</li>
...
if(isset($_POST['submit'])){
	...
	$query = "INSERT INTO Message (sender_id,sender_name,receiver_id,hostel_id,subject_h,message,msg_date,msg_time) VALUES ('$man_id','$roll','$fname','$hostel_id','$subject','$message','$today_date','$time')";
