...
<html lang="en">
<head>
<title> Hostel Management System | Message Board</title>
...
<?php
    ...
    <div class="container">
      ...
      <div class="card-footer"><?php echo "Hostel Manager (".$hostel_name.") - ".$row['sender_name']; ?><span style="float: right"><?php echo $row['msg_date']." ".$row['msg_time']; ?></span></div>
  </div>
</div>
<br><br>
